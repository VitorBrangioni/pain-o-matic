<?php
include_once '../site/global-includes/head.html';
...
$appointment = $appointmentController->findById(1);
$patient = $patientController->findById(1);
$diagram = $diagramController->findById(1);
...
<script src="../tools/js/canvas-backup.js"></script>
